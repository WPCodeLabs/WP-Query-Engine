...
namespace WPCL\QueryEngine\Classes\BeaverBuilder\QueryEngine;
	...
	public function update( $settings ) {
	     ...
	     */
	    	...
	    	foreach ( \FLBuilderLoop::post_types() as $slug => $type ) {
	    		if( isset( $settings->{"match__{$slug}"} ) ) {
 ...
 */
\FLBuilder::register_module( '\\WPCL\\QueryEngine\\Classes\\BeaverBuilder\\QueryEngine\\QueryEngine', array(
	'general'       => array( // Tab
	    ...
	    'sections'      => array( // Tab Sections
	        ...
	        'filter'       => array( // Section
	            ...
	            'fields'        => \WPCL\QueryEngine\Classes\BeaverBuilder\QueryEngine\QueryEngine::get_filter_fields(),
	        ),
	    )
	)
));
